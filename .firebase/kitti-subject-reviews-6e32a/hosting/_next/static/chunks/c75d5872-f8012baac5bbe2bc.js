"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[597],{9516:function(e,t,i){i.d(t,{X:function(){return eV},n:function(){return tK},v:function(){return eK},y:function(){return eG}});var r,n=i(4444),s=i(5816),a=i(3333),o=i(655),l=i(8463);function u(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let c=new n.LL("auth","Firebase",u()),h=new a.Yd("@firebase/auth");function d(e,...t){h.logLevel<=a.in.ERROR&&h.error(`Auth (${s.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e$(e,t,i=!1){let r="signIn",n=await eW(e,r,t),s=await eF._fromIdTokenResponse(e,r,n);return i||await e._updateCurrentUser(s.user),s}function eK(e,t,i,r){return(0,n.m9)(e).onAuthStateChanged(t,i,r)}function eG(e){return(0,n.m9)(e).signOut()}new WeakMap;let eJ="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
