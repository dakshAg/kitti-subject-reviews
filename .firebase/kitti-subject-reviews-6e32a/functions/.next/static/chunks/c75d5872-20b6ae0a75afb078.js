"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[597],{9516:function(e,t,i){i.d(t,{X:function(){return eV},n:function(){return tH}});var r,n=i(4444),s=i(5816),a=i(3333),o=i(655),l=i(8463);function u(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let c=new n.LL("auth","Firebase",u()),h=new a.Yd("@firebase/auth");function d(e,...t){h.logLevel<=a.in.ERROR&&h.error(`Auth (${s.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e$(e,t,i=!1){let r="signIn",n=await eW(e,r,t),s=await eF._fromIdTokenResponse(e,r,n);return i||await e._updateCurrentUser(s.user),s}new WeakMap;let eK="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ts extends em{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return ew(e,this._buildIdpRequest())}_linkToIdToken(e,t){return ew(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return ew(e,this._buildIdpRequest())}_buildIdpRequest(e){let t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function ta(e){return e$(e.auth,new ts(e),e.bypassAuthState)}function to(e){let{auth:t,user:i}=e;return g(i,t,"internal-error"),eH(i,new ts(e),e.bypassAuthState)}async function tl(e){let{auth:t,user:i}=e;return g(i,t,"internal-error"),eq(i,new ts(e),e.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(r)),(0,s.KN)(tF,tz,"esm2017")}}]);